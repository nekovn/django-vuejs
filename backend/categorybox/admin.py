...
class CategoryModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = ["modified",'active']
    list_editable = ["title"]
...
class CategoryItemModelAdmin(admin.ModelAdmin):
    list_display = ["category","title","url","thumbnail_preview","active","created","modified"]
    list_display_links = ["modified","thumbnail_preview",'active','url']
    list_editable = ["title"]
    list_filter = ["created","modified"]
